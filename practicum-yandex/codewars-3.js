...
// I've done some changes to avoid a hardcoding

var maxSequence = function(arr, allPositives, allNegatives, sum){
  allPositives = arr => arr.every(n => n > 0)
  allNegatives = arr => arr.every(n => n < 0)
  sum = arr => arr.reduce((curr_max, max_so_far) => curr_max + max_so_far, 0)
