...
let maxElement = newArr3[0];
for (let i = 0; i < newArr3.length; i++) {
  if (i % 2 === 0 && newArr3[i] > maxElement) {
    maxElement = newArr3[i];
  }
}
...
let maxElement = newArr7[0];
for (let i = 0; i < newArr7.length; i ++) {
  if (newArr7[i] > maxElement && i % 2 === 0) {
    maxElement = newArr7[i];
  }
}
